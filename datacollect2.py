...
target_authors_by_yr = {} #target authors in this case: rejected in year x and have published in years x-5 through x-1
total_authors_by_yr = {}
yr_and_authors = {}
#first_authors_by_yr = {}
rejects_by_yr = {}
...
for i in range(3, rejected_len+1)[::-1]:
    for x in range(column_index_from_string("B"), column_index_from_string("H")+1):
